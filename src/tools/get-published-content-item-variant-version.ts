...
export const getPublishedContentItemVariantVersion = defineReadOnlyTool(
  ...
  "Retrieve the published (live) version and details of a Kontent.ai content item variant. Use when a newer draft version exists but you need the currently published content, not the current/latest draft. Returns the variant snapshot that is live on the Delivery API.",
  {
