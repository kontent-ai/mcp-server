...
export const listItemVariantsByContentType = createTool(
  ...defineTool(
    "list-item-variants-by-content-type",
    "List Kontent.ai item variants filtered by content type (paginated). Find all translated content of a specific type or schema.",
