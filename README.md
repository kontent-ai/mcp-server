...
* **get-patch-operations-context-mapi** – Get comprehensive context and examples for content type patch operations with detailed documentation of move, addInto, remove, and replace operations
* **delete-content-type-mapi** – Delete a content type by codename
